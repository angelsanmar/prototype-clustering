...
class CommunityModel():
    ...
    def initializeComplexSimilarityMeasure(self):
        ...
        """
        daoCommunityModel = DAO_db_users("localhost", 27018, "spice", "spicepassword") 
        similarityDict = {}
    ...
    def computeDistanceMatrix(self):
        ...
        daoDistanceMatrixes = DAO_db_distanceMatrixes("localhost", 27018, "spice", "spicepassword")
...
#--------------------------------------------------------------------------------------------------------------------------
    ...
    def exportCommunityClusteringJSON(self, hecht_beliefR_pivot_df2,community_detection,n_communities,percentageDefault,distanceMatrix):
        ...
        jsonGenerator = CommunityJsonGenerator(json_df,community_detection,n_communities,percentageDefault,distanceMatrix,self.perspective['id'])
...
#--------------------------------------------------------------------------------------------------------------------------
    ...
    def saveDatabase(self,jsonCommunity):
        ...
        daoCommunityModelCommunity = DAO_db_community("localhost", 27018, "spice", "spicepassword")
        # drop previous data
